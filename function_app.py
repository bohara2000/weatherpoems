...
def main(msg: func.QueueMessage, outputBlob: func.Out[str]):
    ...
    # text_clips = [TextClip(line, fontsize=70, color='white',size=(int(1920*text_scale), int(1080*text_scale)), method='caption', align='center')
    #               .set_duration(2)
    #               .crossfadein(0.5)
    #               .crossfadeout(0.5)
    #               for line in lines]
    ...
    final_clip = mp.CompositeVideoClip([bg_clip, total_txt_clips])
